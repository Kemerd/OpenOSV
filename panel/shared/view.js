...
(function (root, factory) {
    ...
    var PALETTES = {
        dark: { switchOff: '#48484a', switchOn: '#30d158' },
        light: { switchOff: '#d1d1d6', switchOn: '#34c759' }
    };
    ...
    function mountView(rootEl, deps) {
        ...
        function render(state) {
            ...
            applySelected.setLabel(state.busy && state.busyLabel.indexOf('selection') !== -1
                ? state.busyLabel : COPY.applySelected);
            applyAll.setLabel(state.busy && state.busyLabel.indexOf('sequence') !== -1
                ? state.busyLabel : COPY.applyAll);

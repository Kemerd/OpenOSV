@echo off
rem Disposable: compile bandprobe.cpp against the existing release build's
rem static libraries (the main checkout's build tree, same commit).
setlocal

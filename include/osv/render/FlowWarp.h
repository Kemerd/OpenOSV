...
// than one large one.
//
// DJI does the same: their shader is RGBAFlowWarpNewTwoFlowShader (note "Two
// Flow"), fed from FlowStitchWarpFusion, and the flow they pass it is
// bidirectional.  A one-sided warp needs one flow field, not two.
//
